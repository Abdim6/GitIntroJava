 ...
 */
public class DropDown_Firefox extends Base_Rapport {
	    ...
	    public void setUp() throws MalformedURLException {
			...
			System.out.println("début setUP firefox");
		//test sur firefox browser
			driver = SetUpDriverBase("firefox");
			System.out.println("Fin setUP firefox");
	    }
	...
	//Vérification de la selection 
			  ...
			  System.out.println("Titre de la page firefox : "+driver.getTitle());
	    ...
	    public void testGoogle() throws InterruptedException
	    {
	          ...
	          if( title.equalsIgnoreCase("google"))
	          {
	  			...
	  			System.out.println("The title google is OK - firefox");
	          }
	          else 
	          {
	    ...
	    { 
	        ...
	        Thread.sleep(2000);     
			System.out.println("I'm in the tearnDown methode - firefox");
	        driver.quit();
	    }
